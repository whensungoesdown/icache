...
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_data_addr0
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_data_addr1
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_data_en
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_data_wdata0
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_data_wdata1
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_data_wr
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_tag_addr
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_tag_en
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_tag_wdata0
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_tag_wdata1
add wave -position end  result:/top_tb/u_top/u_cache_rams/icu_ram_tag_wr
add wave -position end  result:/top_tb/u_top/u_cache_rams/ram_icu_data_rdata0
add wave -position end  result:/top_tb/u_top/u_cache_rams/ram_icu_data_rdata1
add wave -position end  result:/top_tb/u_top/u_cache_rams/ram_icu_tag_rdata0
add wave -position end  result:/top_tb/u_top/u_cache_rams/ram_icu_tag_rdata1

add wave -divider

add wave -position end  result:/top_tb/u_top/u_icu/ic_al_way01_ic2_q
add wave -position end  result:/top_tb/u_top/u_icu/al_cnt_q
add wave -position end  result:/top_tb/u_top/u_icu/al_cnt_in
add wave -position end  result:/top_tb/u_top/u_icu/icu_biu_req
add wave -position end  result:/top_tb/u_top/u_icu/biu_icu_data_valid
